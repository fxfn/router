...
(0, node_test_1.describe)('zod type provider', function () {
                ...
                case 1:
                    ...
                    app.withTypeProvider().route({
                        ...
                        handler: function (req, reply) { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                reply.send({ message: "hi ".concat(req.query.name) });
                                return [2 /*return*/];
                            });
                        }); }
                    });
    ...
    (0, node_test_1.it)('should validate the request types correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    res = _a.sent();
                    node_assert_1.default.ok(res.statusCode === 400, "Should return a status code of 400");
                    return [2 /*return*/];
            }
        });
    }); });
